...
try:    
    ...
    operator.initialize(parameter=False, packet=False)
...
#==============================================================================
    ...
    # 'GRC10002'
        ...
        #operator.setCommandParameter(GRC10002, 'COMMAN16', radix='C', valueType='S', value='TEST2')
        #operator.setCommandParameter(GRC10002, 'COMMAN16', isEng=True, valueType='S', value='TEST')
        #operator.setCommandParameter(GRC10002, 'COMMAN16', radix='C', valueType='S', value='TEST4')
        #operator.setCommandParameter(GRC10002, 'COMMAN05', radix='C', valueType='S', value='TEST3')         
    # 'YMC25104'
...
#==============================================================================
    ...
    # cmd = operator.createCommand(cmdName, numberOfCommands=, absReleaseTime=, relReleaseTime=, absExecutionTime=, staticPtv=, dynamicPtv=, cev=, timeout=)     
    ...
    # ---------------------------- interlock ----------------------------------
    # operator.setCommandInterlock(lastCmdCompleted=, lastCmdFailed=, lastCmdTimeout=)
...
#==============================================================================
    def test_interlock(): 
        ...
        PING_2_11 = operator.createCommand('YYC00000', numberOfCommands=10)               
        operator.setCommandInterlock(PING_2_11, lastCmdCompleted=True)
...
#==============================================================================
    def test_absReleaseTime():
        ...
        PPC00201 = operator.createCommand('PPC00201', absReleaseTime='2018.134.18.09.30.000')
        PING_2_6 = operator.createCommand('YYC00000', absReleaseTime='2018.134.18.09.40.000', numberOfCommands=5)
...
#==============================================================================
    def test_relReleaseTime():
        ...
        PPC00A00 = operator.createCommand('PPC00A00', absReleaseTime='2018.134.18.13.25.928234')
        YMC22003_2_6 = operator.createCommand('YMC22003', numberOfCommands=5, relReleaseTime='00.00.05')
...
#==============================================================================
    def test_absExecutionTime():
        ...
        global PPC00A00   
        PPC00A00 = operator.createCommand('PPC00A00', numberOfCommands=1, absExecutionTime='2018.134.18.16.10.928234')
...
#==============================================================================
    def test_timeout():
        ...
        global PPC00400        
        PPC00400 = operator.createCommand('PPC00400', timeout=60)
        operator.setCommandParameter(PPC00400, 'PPP00004', valueType='D', value=5)
...
#==============================================================================
    def test_timeout2():
        ...
        global PPC00A00
        PPC00A00Kwargs = {'absReleaseTime':'2018.134.19.35.25.928234',
                          'timeout':100}
...
#==============================================================================
    def test_multipleTimeSettings():
        ...
        YMC22003Kwargs = {'absReleaseTime':'2018.134.21.48.40.928234',
                          'timeout':100}
        PING_2_6Kwargs = {'relReleaseTime':'00.00.05',
                          'timeout':100}
        PPC00400_7Kwargs = {'absExecutionTime':'2018.134.21.49.40.928234'}
...
#==============================================================================
    def test_multipleCommands():  
        ...
        PPC02001Kwargs = {'absReleaseTime':'2018.134.21.54.40.928234',
                          'timeout':100}
...
#==============================================================================
    def test_multipleCommands2():
        ...
        DSC32000_1Kwargs = {'absReleaseTime':'2018.134.22.10.40.928234'}           
        YYC00000_2_6Kwargs = {'relReleaseTime':'00.00.04'}
        PPC00201_7Kwargs = {'absReleaseTime':'2018.134.22.11.20.928234'}
        ...
        operator.setCommandInterlock(PPC01900_8_10, lastCmdCompleted=True)
...
#==============================================================================
    ...
    def test_repeater():
        ...
        DSC00001 = operator.createCommand('DSC00001', counter=[('DSP00002', 2), ('DSP00004', 2), ('DSP00006', 1, 3)])
                    
#==============================================================================
#                          Start tests
#==============================================================================    
 
    #test_singleCmd('PPC01900')
    test_ping(1)
    #test_interlock()
    #test_absReleaseTime()
    #test_relReleaseTime()
